...
function calcGoodsPrice(bookPrice,obj){ //상품 가격 계산
...
function modify_cart_qty(goods_id,bookPrice,index){ //장바구니 수량 변경
	//alert(index);
...
function delete_cart_goods(cart_id){ //장바구니 삭제
...
function fn_order_each_goods(goods_id,goods_title,goods_sales_price,fileName){ //개별 주문
...
function fn_order_all_cart_goods(){ //전체 주문
	...
	if(length>1){
 	...
 	objForm.method="post";
 	objForm.action="${contextPath}/order/orderGoodsForm.do";
	objForm.submit();
}
...
<body>
	...
	<center>
    <br><br>	
		 <a href="#" onclick="fn_order_all_cart_goods(); return false;">
