...
<c:otherwise>
	<li>
		...
		<ul>
			...
			<li><a href="${contextPath}/goods/goodsList.do?goods_sort=economy">경제/경영</a></li>
			<li><a href="${contextPath}/goods/goodsList.do?goods_sort=university">대학교재</a></li>
			<li><a href="${contextPath}/goods/goodsList.do?goods_sort=essay">자기계발</a></li>
			<li><a href="${contextPath}/goods/goodsList.do?goods_sort=science">자연과학/공학</a></li>
			<li><a href="${contextPath}/goods/goodsList.do?goods_sort=history">역사/인문학</a></li>
		</ul>
	</li>
	<li>
		<h3>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;음반</h3>
