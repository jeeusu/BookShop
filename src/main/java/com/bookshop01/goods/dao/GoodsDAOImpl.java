...
public class GoodsDAOImpl  implements GoodsDAO{
	...
	@Override
	public List<GoodsVO> selectGoodsSortList(String goodsSort ) throws DataAccessException{
		List<GoodsVO> goodsList=(ArrayList)sqlSession.selectList("mapper.goods.selectGoodsSortList",goodsSort);
		return goodsList;
	}
